...
export interface NotificationSwitchConfig extends SwitchConfig {
    type: SwitchType.DELAY_PROGRESS_NOTIFICATION_SWITCH;
...
export enum SwitchType {
    ...
    DELAY_PROGRESS_NOTIFICATION_SWITCH = 'DELAY_PROGRESS_NOTIFICATION_SWITCH',
    CANCEL_DELAY_NOTIFICATION_SWITCH = 'CANCEL_DELAY_NOTIFICATION_SWITCH',
